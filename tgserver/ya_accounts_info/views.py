...
class YaAccountAPIView(APIView):
    ...
    def post(self,request,*args,**kwargs):
        ...
        new = YaAccountModel.objects.create(name=name,city=city,categories=categories,new_cats=new_cats,new_city=new_city,del_cats=del_cats,need_update=need_update)
