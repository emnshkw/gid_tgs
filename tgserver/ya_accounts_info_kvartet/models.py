...
class YaAccountKvartetModel(models.Model):
    ...
    def __str__(self):
        ...
        self.need_update = need_update == 'Программа вносит изменения'
        self.save()
        return f'{self.name}. {need_update}. {new_cats_len} категорий нужно добавить, {del_cats_len} категорий нужно удалить.'


    class Meta:
        verbose_name = 'Яндекс Аккаунт Квартет'
        verbose_name_plural = 'Яндекс Аккаунты Квартет'